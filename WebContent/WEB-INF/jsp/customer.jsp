...
<%@ taglib prefix="luxinhuo" uri="http://itcast.cn/common/"%>
<%
		...
		<ul class="nav navbar-top-links navbar-right">
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-messages">
					<li><a href="#">
							<div>
								<strong>鲁新火</strong> <span class="pull-right text-muted">
									<em>昨天</em>
								</span>
							</div>
							<div>哈哈哈哈，你收到了一条新消息</div>
					</a></li>
					<li class="divider"></li>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<luxinhuo:page url="${pageContext.request.contextPath }/customer/list.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
